...
public class MainDashboardController {
    ...
    public void showAuctionList(boolean onlyShowMine) {
        ...
        loadViewWithData("/vn/edu/uet/daugia/client/ui/list/auction-grid-view.fxml", onlyShowMine, null);
    }
    ...
    @FXML private void handleMenuMyItems() {
        ...
        loadViewWithData("/vn/edu/uet/daugia/client/ui/list/auction-grid-view.fxml", true, null);
    }

    public void showProductDetail(JsonObject productData) {
        loadViewWithData("/vn/edu/uet/daugia/client/ui/list/product-detail-view.fxml", false, productData);
    }

    public void showPostItemPage() {
        loadViewWithData("/vn/edu/uet/daugia/client/ui/list/seller-post-item.fxml", false, null);
    }
