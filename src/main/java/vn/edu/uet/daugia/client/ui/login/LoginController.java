...
import vn.edu.uet.daugia.client.ui.list.MainDashboardController;
...
public class LoginController {
    ...
    protected void onLoginButtonClick(ActionEvent event) {
        ...
        if (status.equals("SUCCESS")) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/vn/edu/uet/daugia/client/ui/list/main-dashboard.fxml"));
    ...
    protected void switchToRegister() { // Xóa bỏ hoàn toàn chữ 'event' trong ngoặc
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/vn/edu/uet/daugia/client/ui/login/register-view.fxml"));
            Parent root = loader.load();
